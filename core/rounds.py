...
def get_rounds_for_fund(fund_id: str):
    ...
    if len(rounds) > 0:
        ...
        return  {"code" : 404, "message" : f"Rounds for fund_id : {fund_id} cannot be found."}, 404
...
def get_round(fund_id: str, round_id: str):
    ...
    if round:
        ...
        return  {"code" : 404, "message" : f"round_id : {round_id} in fund_id : {fund_id} cannot be found."}, 404
